...
public class AcademiaProgramadorAPP {
    ...
    public static void main(String[] args) {
        ...
        for(int n=0; n<i; n++){
            ...
            String nomeeq;
            do{
            nomeeq = JOptionPane.showInputDialog(null, "Me diz o nome do equipamento (com 6 ou mais caracteres): ");
            }while(nomeeq.length()<6);
            try{
            preco = Double.parseDouble(JOptionPane.showInputDialog(null, "E quanto foi que ele custou? "));
            }catch(NumberFormatException exception){
                JOptionPane.showMessageDialog(null, "Somente os números serão guardados.");
            }
        ...
        //Por meio desta função, pode-se visualizar as informações de cada equipamento resgistrado.
            ...
            //Se quiser editar uma manutenção, esta parte docódigo faz isso.
            else if(var==6){
                String e1 = (JOptionPane.showInputDialog(null, "Qual o nome do equipamento que deseja editar o chamado de manutenção? "));
                user.editmanut(e1);
            }
            
            //É condicionado ao usuário, desmarcar uma manutenção.
            else if(var==7){
                String e1 = JOptionPane.showInputDialog(null, "Me diz, a manutenção de qual equipamento você quer que eu desmarque? ");
                user.removemanut(e1);
            }
            
            //Aqui ocorre uma verificação, para caso o usuário queira registrar novos equipamentos.
            else if(var==8){
                
                 i = Integer.parseInt(JOptionPane.showInputDialog(null, "Quantos equipamentos deseja registrar? "));
